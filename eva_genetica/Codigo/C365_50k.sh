...
####
# Titulo: Bash para calcular mediante blupf90 los valores genéticos en datos parciales y completos para el caracter crecimiento a los 365 días de edad.
...
cd ../Datos/eva_genomica/Beagle_50K/crecimiento_365/Completo
...
echo "OPTION SNP_file ../genoC365_2.txt
...
echo "OPTION SNP_file ../genoC365_2.txt_clean
OPTION method VCE
OPTION sol se
...
cd ../Datos/eva_genomica/Beagle_50K/crecimiento_365/Parcial
