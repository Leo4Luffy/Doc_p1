#!/bin/bash
################################################################
# Parte 4: evaluación de la precisión de la imputación - Parte 2
################################################################
...
cd ../Datos/Beagle/Precision_imputados/Prec_4 # Aquí tuve que cambiar al directorio del respectivo archivo VCF (Prec_1, Prec_2, ..., Prec_4).
