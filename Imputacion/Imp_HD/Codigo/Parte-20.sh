#!/bin/bash
################################################################
# Parte 20: evaluación de la precisión de la imputación - Parte 2
################################################################
...
cd ../Datos/Beagle/Precision_origen/Precision_IBS/Prec_1 # Aquí tuve que cambiar al directorio del respectivo archivo VCF (Prec_1, Prec_2, ..., Prec_4).
